...
{
    private BaseCard[] cardControllerPrefeb;
    protected override void Awake()
    {
        base.Awake();
        cardControllerPrefeb = Resources.LoadAll<BaseCard>("Prefebs/Card");
    }

    public BaseCard CreateCard(int cardID)
    {
        if (CardDataManager.Instance.CardDatas.ContainsKey(cardID))
        {
            ...
            BaseCard card = Instantiate(cardControllerPrefeb[cardType], GameManager.Instance.Player.CurrentDeck.transform);
